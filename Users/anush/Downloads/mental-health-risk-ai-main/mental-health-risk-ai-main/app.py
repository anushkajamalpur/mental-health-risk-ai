...
from models.trend_analyzer import load_history
...
def risk_graph():
    ...
    for entry in history:
        if isinstance(entry, dict):
            ...
            try:
                ...
                # fallback for old entries with only date
    ...
    plt.plot(dates, risks, marker="o", linewidth=2)
    ...
    plt.axhline(0.4, color="green", linestyle="--", label="Low Risk")
    plt.axhline(0.7, color="orange", linestyle="--", label="Moderate Risk") 
